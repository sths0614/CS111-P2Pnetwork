...
run-good: osppeer
	...
	@echo + mkdir test
	@mkdir test
	@echo + ./osppeer -dtest -t164.67.100.233:12997 cat1.jpg cat2.jpg cat3.jpg
	@./osppeer -dtest -t164.67.100.233:12997 cat1.jpg cat2.jpg cat3.jpg

run-slow: osppeer
	@-/bin/rm -rf test
	@echo + mkdir test
	@mkdir test
	@echo + ./osppeer -dtest -t164.67.100.233:12998 cat1.jpg cat2.jpg cat3.jpg
	@./osppeer -dtest -t164.67.100.233:12998 cat1.jpg cat2.jpg cat3.jpg

run-bad: osppeer
	@-/bin/rm -rf test
	@echo + mkdir test
	@mkdir test
	@echo + ./osppeer -dtest -t164.67.100.233:12999 cat1.jpg cat2.jpg cat3.jpg
	@./osppeer -dtest -t164.67.100.233:12999 cat1.jpg cat2.jpg cat3.jpg

run-popular: osppeer
	@-/bin/rm -rf test
	@echo + mkdir test
	@mkdir test
	@echo + ./osppeer -dtest -t164.67.100.233:13000 cat1.jpg cat2.jpg cat3.jpg
	@./osppeer -dtest -t164.67.100.233:13000 cat1.jpg cat2.jpg cat3.jpg
